...
#        if len(time_dependent_parameters):
...
class ModelObject:
    def __init__(self,model,states,boundaries,fixed,
        ...
        self.include = include       #include these parameters in the analysis
        if not self.include:
        ...
        self.parameters = list(set(list(self.boundaries.keys()) + list(self.fixed.keys())))
